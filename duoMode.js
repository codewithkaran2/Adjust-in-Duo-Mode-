...
function drawTopStatus() {
  ...
  // Health bars are drawn in the top left and right corners.
  // Player1 (left)
  ...
  // Updated Name boxes for Duo Mode (improved UI)
  const nameBoxWidth = 250, nameBoxHeight = 40;
  ctx.fillStyle = "white";
  ...
  ctx.fillText("🟦 " + p1Name, leftX + nameBoxWidth / 2, topY + barHeight * 2 + nameBoxHeight / 2 + 6);
  ...
  ctx.fillStyle = "red";
  ctx.textAlign = "center";
  ctx.fillText("🟥 " + p2Name, rightX + nameBoxWidth / 2, topY + barHeight * 2 + nameBoxHeight / 2 + 6);
  ctx.textAlign = "left";
}
